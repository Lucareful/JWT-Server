...
func (ts *tokenStore) Create(ctx context.Context, info service.TokenInfoInterface) error {
	ct := time.Now()
...
func (ts *tokenStore) getData(key string) (service.TokenInfoInterface, error) {
	var ti service.TokenInfoInterface
...
func (ts *tokenStore) GetByCode(ctx context.Context, code string) (service.TokenInfoInterface, error) {
	return ts.getData(code)
}

// GetByAccess use the access token for token information data
func (ts *tokenStore) GetByAccess(ctx context.Context, access string) (service.TokenInfoInterface, error) {
...
func (ts *tokenStore) GetByRefresh(ctx context.Context, refresh string) (service.TokenInfoInterface, error) {
